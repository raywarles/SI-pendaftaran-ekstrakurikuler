                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Formulir Tambah Semester</h2>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="nk-int-st">
                                        <input required type="text" name="semester" class="form-control input-md" placeholder="Semester : Genap/Ganjil">
                                        @if ($errors->has('semester'))
                                          <li><p style="color: red">{{ $errors->first('semester') }}</p></li>
                                       @endif
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="nk-int-st">
                                        <input required type="text" name="tahun" class="form-control input-md" placeholder="Tahun Ajaran">
                                        @if ($errors->has('tahun'))
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <button type="submit" style="float: right;margin-left: 4px;" class="btn btn-success notika-btn-success waves-effect">Simpan</button>
                                 <a style="float: right;" href="{{route('semester')}}" class="btn btn-danger notika-btn-danger waves-effect">Batal</a>
                            </div>
                        </div>
                        </form>
                    </div>
