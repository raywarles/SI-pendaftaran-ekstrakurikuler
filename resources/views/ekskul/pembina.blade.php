                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Sunting Ekstrakurikuler :{{$eks->nama_ekskul}}</h2>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="basic-tb-hd">
                            <h2>Edit Data Ekstrakurikuler : {{$eks->nama_ekskul}}</h2>
                        </div>
                        <form action="{{route('pembina.update',$eks->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="nk-int-st">
                                        <input required type="text" name="nama_ekskul" class="form-control input-md" value="{{$eks->nama_ekskul}}" placeholder="Nama Ekstrakurikuler">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                     ...
                                     <div class="nk-int-st">
                                        <textarea required name="deskripsi" class="html-editor">{!!$eks->deskripsi!!}</textarea>
                                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="basic-tb-hd">
                            <h2>Edit Informasi Pelaksanaan Ekstrakurikuler : {{$eks->nama_ekskul}}</h2>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="cmp-tb-hd bsc-smp-sm">
                                    <label>Hari Ekstrakurikuler</label>
                                </div>
                                <div class="form-group">
                                    <div class="bootstrap-select nk-int-st">
                                        <select name="hari" id="add_fields_placeholder" class="input-md selectpicker">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="nk-int-st">
                                        <input required type="time" name="jam" class="form-control input-md" value="{{$jadwal->jam}}" placeholder="Nama Ekstrakurikuler">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="cmp-tb-hd bsc-smp-sm">
                                    <label>Pengumuman Ekstrakurikuler</label>
                                </div>
                                <div class="form-group">
                                    
                                     <div class="nk-int-st">
                                        <textarea required name="pengumuman" class="html-editor" placeholder="pengumuman">{{$jadwal->pengumuman}}</textarea>
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="nk-int-st">
                                        <input  type="file" name="berkas" class="form-control input-md" placeholder="Nama Ekstrakurikuler">
                                        @if ($errors->has('berkas'))
                                          <li><p style="color: red">{{ $errors->first('berkas') }}</p></li>
                                       @endif
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="basic-tb-hd">
                            <h2>Buat Informasi Pelaksanaan Ekstrakurikuler : {{$eks->nama_ekskul}}</h2>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="nk-int-st">
                                        <input required type="time" name="jam" class="form-control input-md"  placeholder="Nama Ekstrakurikuler">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                     ...
                                     <div class="nk-int-st">
                                        <textarea name="pengumuman" class="html-editor" placeholder="pengumuman"></textarea>
                                    </div>
