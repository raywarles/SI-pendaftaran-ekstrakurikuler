                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Formulir Tambah Ekstrakurikuler</h2>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="basic-tb-hd">
                            <h2>Input Data Ekstrakurikuler</h2>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="nk-int-st">
                                        <input required type="text" name="nama_ekskul" class="form-control input-md" placeholder="Nama Ekstrakurikuler">
                                        @if ($errors->has('nama_ekskul'))
                                          <li><p style="color: red">{{ $errors->first('nama_ekskul') }}</p></li>
                                       @endif
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                     ...
                                     <div class="nk-int-st">
                                        <textarea required name="deskripsi" class="html-editor"></textarea>
                                        @if ($errors->has('deskripsi'))
                                          <li><p style="color: red">{{ $errors->first('deskripsi') }}</p></li>
                                       @endif
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="nk-int-st">
                                        <input required type="file" name="gambar" class="form-control input-md" placeholder="Nama Ekstrakurikuler">
