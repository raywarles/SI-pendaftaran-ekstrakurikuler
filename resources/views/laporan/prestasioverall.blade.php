...
<body style="padding: 50px;">
    <img src="{{asset('assetnya/images/23.png')}}" style="width: 60px;height: auto;position: absolute;">
        ...
        <hr class="line-title">
        <h4 align="center">Laporan Jumlah Prestasi </h4>
            <p align="center">Periode : Semua Semester</p>
        <div class="table-responsive">
            <table class="table table-sm">
                ...
                <tbody>
                    ...
                    @foreach($eks as $ek)
                        <?php 
                            $cek3 = App\Models\Prestasi::where('ekstrakurikuler_id',$ek->id)->get();
                         ?>
                    <tr>
                        <td>{{$no+=1}}</td>
                        <td>{{$ek->nama_ekskul}}</td>
                            <td>{{count($cek3)}} Siswa</td>
                    </tr>
                    @endforeach
