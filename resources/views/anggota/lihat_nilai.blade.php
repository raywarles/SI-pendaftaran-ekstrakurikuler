							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>Penilaian Anggota : {{$anggota->nama}} <br> Tahun Ajaran : {{$semester->semester}} - {{$semester->tahun}} <br> Ekstrakurikuler : {{$eskul->nama_ekskul}}</h2>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="" class="table table-bordered table-responsive">
                                ...
                                @foreach($soals as $soal)    
                                    ...
                                    <?php 
                                        $oi = App\Models\Jawaban::where('soal_id',$soal->id)->where('riwayat_id',$riwayat->id)->first();
                                    ?>
                                    <tr>
                                        <td>{{$soal->soal}}</td>
                                        <td>@if($oi->jawaban == 'S') <i class="fa fa-check"></i>  @endif</td>
                                        <td>@if($oi->jawaban == 'SR') <i class="fa fa-check"></i>  @endif</td>
                                        <td>@if($oi->jawaban == 'KD') <i class="fa fa-check"></i>  @endif</td>
                                        <td>@if($oi->jawaban == 'TP') <i class="fa fa-check"></i>  @endif</td>
