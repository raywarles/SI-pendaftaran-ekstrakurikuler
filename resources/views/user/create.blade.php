                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="basic-tb-hd">
                            <h2>Formulir</h2>
                            <p>Isi data sesuai kolom yang ditentukan.</p>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <select name="level" id="add_fields_placeholder" class="input-md selectpicker">
                            ...
                            <div id="add_fields_placeholderValue" class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    <div class="form-ic-cmp">
                                        <i class="notika-icon notika-settings"></i>
                                    </div>
                                    <div class="bootstrap-select fm-cmp-mg">
                                    <select name="ekstrakurikuler_id" class="input-md selectpicker">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <button style="float: right;margin-left: 4px;" class="btn btn-success notika-btn-success waves-effect">Simpan User</button>
